...
public class Wrist extends SubsystemBase
{
  ...
  private void initSmartDashboard( )
  {
    ...
    SmartDashboard.putNumber("WR_lowAngle", m_wristAngleLow);
    SmartDashboard.putNumber("WR_midAngle", m_wristAngleMid);
    SmartDashboard.putNumber("WR_highAngle", m_wristAngleHigh);
  ...
  public void moveWristAngleInit(WristAngle angle)
  {
    if (m_wristDebug)
    {
      ...
      m_wristAngleLow = SmartDashboard.getNumber("WR_lowAngle", m_wristAngleLow);
      m_wristAngleMid = SmartDashboard.getNumber("WR_midAngle", m_wristAngleMid);
      m_wristAngleHigh = SmartDashboard.getNumber("WR_highAngle", m_wristAngleHigh);
    }
