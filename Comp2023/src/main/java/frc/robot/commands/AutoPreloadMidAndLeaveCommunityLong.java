 ...
 *
 */
public class AutoPreloadMidAndLeaveCommunityLong extends SequentialCommandGroup
{
  public AutoPreloadMidAndLeaveCommunityLong(Swerve swerve, Elbow elbow, Extension extension, Wrist wrist, Gripper gripper,
      String pathName, PathPlannerTrajectory trajectory)
  {
    setName("AutoPreloadMidAndLeaveCommunityLong");
