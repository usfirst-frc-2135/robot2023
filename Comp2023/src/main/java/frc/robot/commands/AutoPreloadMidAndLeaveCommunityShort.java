 ...
 *
 */
public class AutoPreloadMidAndLeaveCommunityShort extends SequentialCommandGroup
{
  public AutoPreloadMidAndLeaveCommunityShort(Swerve swerve, Elbow elbow, Extension extension, Wrist wrist, Gripper gripper,
      String pathName, PathPlannerTrajectory trajectory)
  {
    setName("AutoPreloadMidAndLeaveCommunityShort");
