...
public class Constants
{
  ...
  public static final class EXConsts
  {
    ...
    public static final double        kLengthScoreLow           = 9.0;   // From Mech Design (floor, feet art 5" high), empirically checked
    public static final double        kLengthScoreMid           = 0.25;  // From Mech Design (1'10-3/4" deep, 2'10" high peg, 1'11-1/2 high cube), empirically checked
  ...
  public static final class WRConsts
  {
    ...
    public static final double               kAngleScoreMid            = kAngleIdle + 20;  // From Mech Design (1'10-3/4" deep, 2'10" high peg, 1'11-1/2 high cube), ready to score
    public static final double               kAngleScoreHigh           = kAngleIdle + 20;  // From Mech Design (3'3-3/4" deep, 3'10" high peg, 2'11-1/2 high cube), ready to score
