...
public class Auto3BallLeft extends SequentialCommandGroup
{
  ...
  public Auto3BallLeft(Swerve swerve, Intake intake, FloorConveyor fConv, TowerConveyor tConv, Shooter shooter, Vision vision)
  {
    ...
    addCommands(
        ...
        new ParallelDeadlineGroup (
          ...
          new AutoDrivePath(swerve, AUTOConstants.k3BallLeft_path1, true),
        ...
        new ParallelDeadlineGroup(
          new WaitUntilCommand(swerve::driveWithPathFollowerIsFinished),
          new AutoDrivePath(swerve, AUTOConstants.k3BallLeft_path2, false),
        ...
        new ParallelDeadlineGroup(
          new WaitUntilCommand(swerve::driveWithPathFollowerIsFinished),
          new AutoDrivePath(swerve, AUTOConstants.k3BallLeft_path3, false),
          new IntakingAction(intake, fConv, tConv) 
        ),
        ...
        new ParallelDeadlineGroup(
          new WaitUntilCommand(swerve::driveWithPathFollowerIsFinished),
          new AutoDrivePath(swerve, AUTOConstants.k3BallLeft_path4, false),
          new ScoringPrime(shooter, vision),
          new IntakingAction(intake, fConv, tConv) 
        ),
