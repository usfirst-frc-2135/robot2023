package frc.robot.team254.lib.drivers;
...
public class TalonFXFactory
{
  ...
  public static TalonFX createTalon(int id, Configuration config)
  {
    ...
    talon.setStatusFramePeriod(StatusFrameEnhanced.Status_4_AinTempVbat, config.ANALOG_TEMP_VBAT_STATUS_FRAME_RATE_MS,
        kTimeoutMs);
